<h1>3783 - Permutations IV</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/permutations-iv/">permutations-iv</a></h2><p>Given two integers, <code>n</code> and <code>k</code>, an <strong>alternating permutation</strong> is a permutation of the first <code>n</code> positive integers such that no <strong>two</strong> adjacent elements are both odd or both even.</p>
