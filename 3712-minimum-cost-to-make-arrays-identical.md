<h1>3712 - Minimum Cost to Make Arrays Identical</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-cost-to-make-arrays-identical/">minimum-cost-to-make-arrays-identical</a></h2><p>You are given two integer arrays <code>arr</code> and <code>brr</code> of length <code>n</code>, and an integer <code>k</code>. You can perform the following operations on <code>arr</code> <em>any</em> number of times:</p>
